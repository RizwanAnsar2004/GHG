...
# Paths to your NetCDF files for methane emissionsfrom pathlib import Path

# Get the current directory where the script is located
current_dir = Path(__file__).resolve()

# Construct the base path dynamically, relative to the script's location
base_path = current_dir.parent / 'datasetsNASAPROGRAMS' / 'gridded GHGI'

# Generate file paths dynamically for the years 2012-2018
years = [str(year) for year in range(2012, 2019)]
file_paths = {year: base_path / f'Gridded_GHGI_Methane_v2_{year}.nc' for year in years}
...
co2_data_path = current_dir.parent / 'datasetsNASAPROGRAMS' / 'annual-co2-emissions-per-country.csv'
